...
line2.set_marker('.')
plt.loglog(mytable['MASS_EXTRAP'][index],mytable['VIRMASS_EXTRAP_DECONV'][index],marker='x',c='b',linestyle='None')
...
plt.loglog(mytable['RADRMS_EXTRAP_DECONV'][index],mytable['VRMS_EXTRAP_DECONV'][index],marker='x',c='b',linestyle='None')
...
figure = plt.figure(figsize=(4.5,4)) #figure size in inches
line1, line2 = plt.loglog(R,M_vir,mytable['RADRMS_EXTRAP_DECONV'],mytable['MASS_EXTRAP'])
line1.set_linestyle('-')
line1.set_color('k')
line2.set_linestyle('None')
line2.set_marker('.')
...
plt.loglog(mytable['RADRMS_EXTRAP_DECONV'][index],mytable['MASS_EXTRAP'][index],marker='x',c='b',linestyle='None')
